...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('removerole')
        .setDescription('remove role from target')
        .setDefaultPermission(false)
        .addSubcommand(subcommand =>
            subcommand
                .setName('all')
                .setDescription('all members in guild')
                .addRoleOption(option => option.setName('role').setDescription('role you want remove').setRequired(true))),
